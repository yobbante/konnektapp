  ...
  return (
    ...
    >
      <button
        ...
        className="absolute top-2 right-2 h-7 w-7 rounded-full text-[var(--muted-foreground)] hover:text-[var(--foreground)]/85 hover:bg-[var(--foreground)]/5 flex items-center justify-center transition-colors"
      >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="text-sm font-semibold text-[var(--foreground)]">Sécurisez votre compte</div>
          <p className="text-xs text-[var(--foreground)]/75 mt-0.5 leading-relaxed">
              ...
              >
                {mode === "choose" && (
                  <>
                    <Button
                      ...
                      disabled={submitting}
                      className="w-full h-10 rounded-xl bg-[var(--foreground)] text-background hover:bg-[var(--foreground)]/90 text-xs font-semibold gap-2"
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="w-full h-10 rounded-xl border-[var(--foreground)]/15 hover:bg-[var(--foreground)]/5 text-xs font-semibold gap-2"
                    >
                ...
                {mode === "email" && (
                  <div className="space-y-2.5">
                    <div>
                      <Label className="text-[11px] text-[var(--muted-foreground)]">Email</Label>
                      <Input
                        type="email"
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        placeholder="vous@exemple.com"
                        className="h-10 rounded-xl bg-[var(--foreground)]/8 border-foreground/10 mt-1"
                        autoComplete="email"
                      />
                    </div>
                    <div>
                      <Label className="text-[11px] text-[var(--muted-foreground)]">Mot de passe (≥ 8 caractères)</Label>
                      <Input
                        type="password"
                        value={password}
                    ...
                    <div className="flex gap-2">
                      <Button onClick={() => setMode("choose")} variant="ghost" size="sm" className="h-9 text-xs text-[var(--foreground)]/75">
                        Retour
                      </Button>
                      <Button
                ...
                {mode === "reset" && (
                  <div className="space-y-2.5">
                    <div>
                      <Label className="text-[11px] text-[var(--muted-foreground)]">Email du compte</Label>
                      <Input
                        type="email"
                        value={resetEmail}
                        ...
                        autoComplete="email"
                      />
                      <p className="text-[10px] text-[var(--foreground)]/40 mt-1.5 leading-relaxed">
                        Vous recevrez un lien pour définir un nouveau mot de passe.
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <Button onClick={() => setMode("email")} variant="ghost" size="sm" className="h-9 text-xs text-[var(--foreground)]/75">
                        Retour
                      </Button>
                      <Button
