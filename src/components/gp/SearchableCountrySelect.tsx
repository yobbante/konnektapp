...
export const CITIES_BY_COUNTRY: Record<string, string[]> = {
  FR: ["Paris", "Lyon", "Marseille", "Toulouse", "Bordeaux", "Lille", "Nice", "Nantes", "Strasbourg"],
  ...
  US: ["New York", "Los Angeles", "Chicago", "Houston", "Miami", "Atlanta", "Washington"],
  ...
  ES: ["Madrid", "Barcelone", "Valence", "Séville", "Malaga"],
