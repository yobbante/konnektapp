...
import {
  ...
  History, Wallet, Calendar, DollarSign,
...
export function MaritimeDashboardLayout({
  ...
  useEnforceDashboardRole("maritime");
            ...
            <div className={cn(
              ...
              {walletData ? (
                <div className="space-y-3">
                  ...
                  <button onClick={() => { setShowWallet(false); navigate("/maritime/wallet"); }} className="w-full flex items-center justify-center gap-2 bg-white/15 hover:bg-white/25 text-white text-xs font-semibold py-2.5 rounded-xl transition-all active:scale-[0.98]">
          ...
          <Sheet open={showMenu} onOpenChange={setShowMenu}>
            ...
            <SheetContent side="bottom" className="rounded-t-2xl pb-safe">
              ...
              <div className="grid grid-cols-3 gap-3 pb-3">
                <MenuBtn icon={BarChart3} label="Performances" onClick={() => { setShowMenu(false); navigate("/maritime/apercu"); }} />
                ...
                <MenuBtn icon={DollarSign} label="Tarifs" onClick={() => { setShowMenu(false); navigate("/maritime/parametres"); }} />
                ...
                <MenuBtn icon={Shield} label="KTP & Geo" onClick={() => { setShowMenu(false); navigate("/maritime/apercu"); }} />
