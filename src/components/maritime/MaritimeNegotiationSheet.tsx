/**
 * MaritimeNegotiationSheet - Proposal sheet for maritime freight requests
 * GP proposes price, transit days, routing, and included services
 */
import { useState } from "react";
import { motion } from "framer-motion";
import {
  Ship, Check, MessageCircle, DollarSign, Clock, Loader2, ArrowRight,
  Shield, Package, Anchor
} from "lucide-react";
...
interface MaritimeNegotiationSheetProps {
  open: boolean;
...
export function MaritimeNegotiationSheet({
  open, onOpenChange, request, proposal, gpId, onSuccess
}: MaritimeNegotiationSheetProps) {
        ...
        <div className="space-y-4">
          ...
          <div className="bg-muted/50 rounded-xl p-3 space-y-1.5">
            ...
            <div className="flex flex-wrap gap-1.5">
              {request.volume_m3 && <Badge variant="outline" className="text-[10px]">{request.volume_m3} m³</Badge>}
              {request.weight_kg && <Badge variant="outline" className="text-[10px]">{request.weight_kg} kg</Badge>}
              {request.merchandise_description && (
                <Badge variant="secondary" className="text-[10px]">{request.merchandise_description}</Badge>
              )}
            </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9 h-11 text-base font-semibold"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              placeholder="Shenzhen → Singapour (transbordement) → Dakar"
              value={routing}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between p-2.5 rounded-lg bg-muted/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs">Dédouanement</span>
                </div>
              ...
              <div className="flex items-center justify-between p-2.5 rounded-lg bg-muted/50">
                <div className="flex items-center gap-2">
                  <Shield className="w-3.5 h-3.5 text-primary" />
                  <span className="text-xs">Assurance maritime</span>
                </div>
              ...
              <div className="flex items-center justify-between p-2.5 rounded-lg bg-muted/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs">Livraison finale (dernier km)</span>
                </div>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              placeholder="Conditions, délais, informations supplémentaires..."
              value={message}
