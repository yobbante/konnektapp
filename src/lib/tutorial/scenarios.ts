...
export const clientScenarios: TutorialScenario[] = [
  {
    ...
    steps: [
      ...
      { id: "c1-7", title: "Suivi en transit", description: "Votre colis est en route.", instruction: "Le statut se met à jour à chaque étape du voyage.", actionIcon: "", actionLabel: "Voir le suivi", mockScreen: "tracking", status: "locked" },
  ...
  },
  {
    ...
    category: "litige",
    steps: [
      { id: "c7-1", title: "Ouvrir un litige", description: "Signalez un problème.", instruction: "Depuis le suivi, cliquez « Signaler un problème ».", actionIcon: "", actionLabel: "Signaler", mockScreen: "dispute-form", status: "locked" },
...
export const gpScenarios: TutorialScenario[] = [
  {
    ...
    category: "mission",
    steps: [
      { id: "g1-1", title: "Déclarer un voyage", description: "Créez votre prochain départ.", instruction: "Indiquez trajet, date, capacité et tarif au kilo.", actionIcon: "", actionLabel: "Déclarer un vol", mockScreen: "declare-flight", status: "locked" },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "g6-2", title: "Impact stratégique", description: "Pas de bonus KTP.", instruction: "Les colis manuels ne comptent pas pour votre Trust Score™.", actionIcon: "", actionLabel: "Voir l'impact", mockScreen: "badge-info", status: "locked" },
    ],
  },
  {
    id: "gp-kyc",
    ...
    steps: [
      ...
      { id: "g7-3", title: "Configurer la route", description: "Définissez votre trajet fixe.", instruction: "Cette route sera verrouillée après validation admin.", actionIcon: "", actionLabel: "Définir la route", mockScreen: "declare-flight", status: "locked" },
