      ...
      <AnimatePresence>
        {(step === "form" || step === "success") && (
          <motion.section
            ...
            className="px-6 pb-10 max-w-xl mx-auto border-t border-foreground/10 pt-10"
          >
            <h2 className="text-xl font-semibold mb-1">Votre premier départ</h2>
            <p className="text-sm text-foreground/50 mb-6">Tout sur un seul écran. Moins d'une minute.</p>
            ...
            <div className="space-y-4">
              <FieldRow icon={<User className="w-4 h-4" />} label="Nom">
                <Input
                  ...
                  className="h-12 rounded-xl bg-foreground/5 border-foreground/10 text-foreground placeholder:text-foreground/30"
                />
              </FieldRow>
              ...
              <div className="grid grid-cols-2 gap-3">
                <FieldRow icon={<Calendar className="w-4 h-4" />} label="Date">
                  <Input
                    ...
                    className="h-12 rounded-xl bg-foreground/5 border-foreground/10 text-foreground"
                  />
                </FieldRow>
      ...
      <AnimatePresence>
        {step === "success" && (
          <motion.section
            ...
            className="px-6 pb-32 max-w-xl mx-auto border-t border-foreground/10 pt-10"
          >
            ...
            <a
              ...
              className="mt-4 flex items-center justify-center gap-2 h-12 rounded-2xl border border-foreground/15 hover:bg-foreground/5 text-sm font-medium transition-colors"
            >
            ...
            <div className="mt-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs text-foreground/50 hover:text-foreground/80"
                >
              ...
              {opportunities.length === 0 ? (
                <Card className="bg-foreground/5 border-foreground/10 p-6 text-center">
                  <Package className="w-6 h-6 text-foreground/30 mx-auto mb-2" />
                  <p className="text-sm text-foreground/70">Des colis sont en cours d'ajout</p>
                  <p className="text-xs text-foreground/40 mt-1">Vous serez notifié dès qu'une opportunité correspond.</p>
                </Card>
              ) : (
                <div className="space-y-2.5">
                  {opportunities.map((op) => {
                    ...
                    return (
                      <Card key={op.id} className="bg-foreground/5 border-foreground/10 p-4">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <Badge variant="outline" className="border-foreground/15 text-foreground/60 text-[10px] shrink-0">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Button
                variant="outline"
                className="h-12 rounded-2xl border-foreground/15 text-foreground hover:bg-foreground/5"
                onClick={() => {
...
function FieldRow({ icon, label, children }: { icon: React.ReactNode; label: string; children: React.ReactNode }) {
  return (
    <div>
      <Label className="flex items-center gap-1.5 text-xs text-foreground/50 mb-1.5">
        {icon} {label}
      </Label>
      {children}
    </div>
