    ...
    try {
      ...
      const { data: order, error } = await supabase
        ...
        .insert({
          ...
          pickup_address: pickupMode === "collecte" ? pickupAddress : (gpProfile.deposit_address || "Dépôt transporteur"),
          item_description: `${PACKAGE_TYPES.find(t => t.id === packageType)?.label || packageType} - Taille ${selectedSize}`,
          ...
          declared_value: wantInsurance ? parseFloat(declaredValue) || 0 : 0,
